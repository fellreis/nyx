...
import { MessageSquare, CheckCircle, Sliders, Award } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <Card className="bg-nyx-50 border-nyx-200 dark:bg-nyx-500/10 dark:border-nyx-500/30">
                    <div className="p-5 text-center">
                        ...
                        <p className="text-sm text-nyx-800 dark:text-nyx-200 font-medium">Points Earned This Month</p>
